...
$output1 .= '<td><a href="edit_features.php?id='.$row["id"].'" class="btn btn-info">Edit</a><a onClick=(deleteFeatures('.$row["id"].')) class="btn btn-info">Delete</a></td>';
$output1 .= '</tr>';
                        ...
                        <form method="post" class="form" id="frm_item_setup" name="frm_item_setup">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Features Setup</h4>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="form-group ">
                                        <div class="row ">
                                            <div class="col-sm-12">
                                                <label for="feature_icon">Image</label>
                                                <input type="file" class="form-control square" id="feature_icon"
                                                    name="feature_icon">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row ">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="form-control square" id="feature_name"
                                                    name="feature_name" placeholder="Enter the feature name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row ">
                                            <div class="col-sm-12">
                                                <label for="feature_short_des">Short Description</label>
                                                <input type="text" class="form-control square" id="feature_short_des"
                                                    name="feature_short_des"
                                                    placeholder="Enter the feature short description">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row ">
                                            <div class="col-sm-12">
                                                <label for="feature_long_des">Long Description</label>
                                                <input type="text" class="form-control square" id="feature_long_des"
                                                    name="feature_long_des"
                                                    placeholder="Enter the feature long description">
                                            </div>
                                        </div>
                                    </div>
...
function addRecord() {
    ...
    var feature_short_des = $("#feature_short_des").val();
    var feature_long_des = $("#feature_long_des").val();
    var formData = new FormData();
    formData.append("feature_icon", feature_icon)
    formData.append("feature_name", feature_name)
    formData.append("feature_short_des", feature_short_des)
    formData.append("feature_long_des", feature_long_des)


    // var item_status = $("#status").val();
    // var image = $('#image')[0].files[0];
    if (feature_icon == "") {
        alert("Please input feature icon");
        console.log('success');
        console.log('failure');
        return false;
    }
    if (feature_name == "") {
        alert("Please input feature name");
        console.log('success');
        console.log('failure');
        return false;
    }
    if (feature_short_des == "") {
        alert("Please input feature short des");
        console.log('success');
        console.log('failure');
        return false;
    }
    if (feature_long_des == "") {
        alert("Please input feature long des");
        console.log('success');
        console.log('failure');
        return false;
    }
    ...
    request.open('POST', 'features_insert.php', true);
...
function deleteFeatures(id) {
    var url = 'features_delete.php?id=' + id;
    $.ajax({
        url: url,
        type: 'GET',
        success: function(item) {
