...
If(!empty($_POST)){
    ...
    $sdesc = mysqli_real_escape_string($connection, $_POST["sdes"]);
	$desc = mysqli_real_escape_string($connection, $_POST["art"]);
   
	$sstatus = mysqli_real_escape_string($connection, $_POST["status"]);
  


	$query = "INSERT INTO product(pname,category,subcategory,sdesc,des,image,status)
       VALUES ('$title','$category','$subcat', '$sdesc', '$desc', '$imagefile', '$sstatus')";
