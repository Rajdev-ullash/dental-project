      ...
      <div class="container">
        ...
        <div id="modal-item" class="modal fade text-xs-left in" role="dialog" tabindex="-1" aria-labelledby="myModalLabel1"> 
          <div class="modal-dialog" role="document">
                ...
                <div class="form-group ">
                  <div class="row ">
                    <div class="col-sm-12">
                      ...
                      <input  type="text"class="form-control square" id="category_name" name="category_name" placeholder="Enter the menu link without extention">
                    </div>
                  </div>
                </div>
                 <div class="form-group ">
                  <div class="row ">
                    <div class="col-sm-12">
                      ...
                      <input  type="text"class="form-control square" id="category_des" name="category_des" placeholder="Enter the menu link without extention">
                    </div>
                  </div>
                </div>
                <div class="form-group ">
                  <div class="row ">
                    <div class="col-sm-12">
                      ...
                      <input  type="text"class="form-control square" id="sl" name="sl" placeholder="Position in list">
                    </div>
                  </div>
                </div>
            ...
            <div id="modal-edit" class="modal fade text-xs-left in" role="dialog" tabindex="-1" aria-labelledby="myModalLabel1"> 
          <div class="modal-dialog" role="document">
            <!-- Modal content-->
               ...
               <div class="modal-body">
                <div class="form-group ">
                  <div class="row ">
                    <div class="col-sm-12">
                      <label  for="category_name">Dentist Name</label>
                      <input  type="text"class="form-control square" id="category_name2" name="category_name2" placeholder="Enter the menu link without extention">
                 ...
                 <div class="form-group ">
                  <div class="row ">
                    <div class="col-sm-12">
                      <label  for="category_name">Description</label>
                      <input  type="text"class="form-control square" id="category_des2" name="category_des2" placeholder="Enter the menu link without extention">
                  ...
                  <div class="row ">
                    <div class="col-sm-12">
                      ...
                      <input  type="text"class="form-control square" id="sl2" name="sl2" placeholder="Enter the menu link without extention">
                ...
                <div class="modal-footer">
                  ...
                  <button type="button" onclick="editRecord()" class="btn btn-success btn-lg">Save</button>
