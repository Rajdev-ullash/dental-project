              ...
              <div class="modal-header">
               ...
               <div class="modal-body">
                    <div class="form-group">
                      <label  for="menu_head">Category Name</label>
                      <select type="text" class="form-control square" id="category" name="category" placeholder="Enter category">
                        <?php
                      ...
                      <div class="form-group">
                      <label  for="menu_head">Subcategory Name</label>
...
function save() {
  ...
  request.open('POST', 'subcategory_insert.php', true);
  ...
  var output1='';
  if(return_data=="1"){
    alertify.success('Subcategory Inserted');
