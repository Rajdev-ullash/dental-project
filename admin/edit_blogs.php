...
$i=$_GET["id"];
  $pquery = "SELECT * FROM blogs WHERE id='$i'";
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <form method="post" class="form-horizontal" id="frm_item_setup"
                                    enctype="multipart/form-data" action="blogs_edit.php">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="form-control square" id="blog_name"
                                                    name="blog_name" value="<?php echo $prow["name"];  ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="form-control square" id="blog_short_des"
                                                    name="blog_short_des" value="<?php echo $prow["short_desc"];  ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="form-control square" id="blog_long_des"
                                                    name="blog_long_des" value="<?php echo $prow["long_desc"];  ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success btn-md">Save</button>
                                        <a href="blogs.php" class="btn btn-warning btn-md">Back</a>
