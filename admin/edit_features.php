...
$i=$_GET["id"];
  $pquery = "SELECT * FROM features WHERE id='$i'";
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <form method="post" class="form-horizontal" id="frm_item_setup"
                                    enctype="multipart/form-data" action="features_edit.php">
                                    <div class="form-group ">
                                        <div class="row ">
                                            <div class="col-sm-12">
                                                ...
                                                <img src="<?php echo $prow["image"]; ?>" alt="Current Icon" width="50"
                                                    height="50">
                                                <?php endif; ?>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="form-control square" id="feature_name"
                                                    name="feature_name" value="<?php echo $prow["name"];  ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="text" class="form-control square" id="feature_long_des"
                                                    name="feature_long_des" value="<?php echo $prow["long_desc"];  ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success btn-md">Save</button>
                                        <a href="features.php" class="btn btn-warning btn-md">Back</a>
