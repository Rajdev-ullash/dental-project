...
$i=$_GET["id"];
$pquery = "SELECT * FROM engineer WHERE id='$i'";
          ...
          <div class="card-body">
            <div class="row ">
             ...
             <div class="form-group">
                    ...
                    <input type="text" class="form-control square" id="ename" name="ename">
                    </div><!--end form group -->
                    <div class="form-group">
                      <label for="item_spec">Address</label>
                      <input type="text" class="form-control square" id="address" placeholder="Enter specification" name="address">
                      </div><!--end form group -->
                   
                       <div class="form-group">
                        <div class="row ">
                          <div class="col-sm-6">
                          <label for="item_spec">Mobile no</label>
                          <input type="text" class="form-control square" id="mob" placeholder="Enter specification" name="mob">
                          </div><!--end form group -->
                          
                          <div class="col-sm-6">
                          <label for="item_spec">NID</label>
                          <input type="text" class="form-control square" id="nid" placeholder="Enter specification" name="nid">
                          </div><!--end form group -->
                        ...
                        <div class="row ">
                          <div class="col-sm-6">
                            <label for="item_category">Category</label>
                             <select class="form-control square" id="cat" name="cat">
                             <option value="">---Select one---</option>
                            <option value="sd vaccu">Pro</option>
                            <option value="codefree">Expert</option>
                            <option value="codefree">Trainee</option>
                            </select>
                          </div>
                          <div class="col-sm-6">
                          <label for="item_spec">Commission</label>
                          <input type="text" class="form-control square" id="comm" placeholder="Enter specification" name="comm">
                          </div><!--end form group -->
