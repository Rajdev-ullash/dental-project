...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <title>Iconic Dental Website Admin Panel</title>
        ...
        <div class="card border-grey border-lighten-3 m-0">
            ...
            <div class="card-body collapse in">
                <div class="card-block">
                     <p><?php echo $msg; ?></p>
                    <form method="post" class="form-horizontal form-simple" action="index.php" name="user_info">
                        <fieldset class="form-group position-relative has-icon-left mb-0">
                            <input type="text" class="form-control form-control-lg input-lg" id="username" placeholder="Your Username" name="username" required>
                        ...
                        <button type="submit" class="btn btn-primary btn-lg btn-block" id="button"><i class="icon-unlock2"></i> Login</button>
                    </form>
                </div>
            </div>
