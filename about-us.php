    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <div class="services-details-content pt-70">
                    <br>
                    <p>Dr. Rizwan's Iconic Dental Implant & Laser Center is a prominent dental care provider in
                        Chattogram well known for its state-of-the-art technologies, advanced dental services, 5-star
                        environment and unparalleled patient service. Iconic Dental always gives priority on patient's
                        long term dental health and provides treatments accordingly. The combination of experienced and
                        specialized team of dentists along with our emphasis on hygiene, sterility and painless protocol
                        will ensure the best dental treatment as per your need.</p>
                    <p>Iconic Dental is a family friendly dental care center. We always focus on the comfort and
                        satisfaction of our patient by ensuring a top class atmosphere and service. We have encompassed
                        the latest tools and technology to give you the best possible treatment in a modern, friendly
                        environment. One of the specialties of Iconic Dental is that we provide additional support to
                        our patient online or over phone whenever they need.</p>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <div class="single-gallery">
                                <img src="gallery/0t.jpg" alt="image">
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4">

                            <div class="single-gallery">
                                <img src="gallery/2t.jpg" alt="image">
                            </div>
                        </div>

                        <div class="col-lg-4 col-md-4">
                            <div class="single-gallery">
                                <img src="gallery/3t.jpg" alt="image">
                            </div>
                        </div>
                    </div>
                </div>
